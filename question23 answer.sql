...
-- Display the name of 4 cities that start and end with a
...
-- Find all the customers whose first name starts with a and have atleast five characters in length
...
-- Get the films with rating pg and pg 13 using in operator
select * from film;
select title from film where rating = 'PG' or 'PG-13';

-- Get the films with the title length between 50 to 100 using between operator
...
-- Get the distinct film id from the inventory table
